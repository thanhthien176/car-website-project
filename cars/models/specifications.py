...
class DimensionSpecification(SpecificationDisplayMixin, models.Model):
    ...
    turning_radius = models.CharField(default="", blank=True, help_text="Bán kính vòng quay tối thiểu (m)")
    
    wheelbase = models.CharField(default="", blank=True, help_text="Chiều dài cơ sở(mm)")
    ground_clearance = models.CharField(max_length=150, default="", blank=True, help_text="Khoảng sáng gầm xe(mm)")
    
    unloaded_weight = models.CharField(max_length=150, default="", blank=True, help_text="Trọng lượng không tải (kg)")
    full_loaded_weight = models.CharField(max_length=150, default="", blank=True, help_text="Trọng lượng toàn tải (kg)")   
    seating_capacity = models.CharField(max_length=150, default="", blank=True, help_text="Số chỗ ngồi")
    fuel_tank_capacity = models.CharField(max_length=150, default="", blank=True, help_text="Dung tích bình nhiên liệu(lít)")
...
class EngineSpecification(SpecificationDisplayMixin, models.Model):
    ...
    cylinder_arrangement = models.CharField(max_length=150, blank=True, help_text="Bố trí xy lanh")
    displacement = models.CharField(max_length=150, blank=True, help_text="Dung tích xi lanh(cc)")
    variable_valve_system = models.CharField(max_length=150, blank=True, help_text="Hệ thống van biến thiên")
    compression_ratio = models.CharField(max_length=150, blank=True, help_text="Tỉ số nén")
    ...
    # electric motor
    electric_motor_mp = models.CharField(max_length=150, blank=True, help_text="Công suất tối đa KW (động cơ điện)")
    electric_motor_mt = models.CharField(max_length=150, blank=True, help_text="Momen xoắn tối đa Nm")
    hybrid_batteries = models.CharField(max_length=150, blank=True, help_text="Ắc quy hybrid")
    
    drive_mode = models.CharField(max_length=100, blank=True, help_text="Các chế độ lái")
    drive_train = models.CharField(max_length=150, blank=True, help_text="Hệ thống truyền động")
    transmission = models.CharField(max_length=150, choices=TRANSMISSION_CHOICES, help_text="Hộp số")
...
class PerformanceSpecification(SpecificationDisplayMixin, models.Model):
    ...
    # suspension
    suspension = models.CharField(max_length=200, blank=True, help_text="Hệ thống treo")
    suspension_font = models.CharField(max_length=150, blank=True, help_text="Hệ thống treo trước")
    suspension_rear = models.CharField(max_length=150, blank=True, help_text="Hệ thống treo sau")

    power_steering = models.CharField(max_length=100, blank=True, help_text="Trợ lực tay lái")
    
    
    # Tire & wheel
    rim_type = models.CharField(max_length=150, blank=True, help_text="Loại vành")
    tire_size = models.CharField(max_length=150, blank=True, help_text="Kích thước lốp xe")
    spare_tire = models.CharField(max_length=150, blank=True, help_text="Lốp dự phòng")
    
    brake = models.CharField(max_length=150, blank=True, help_text="Hệ thống phanh trước/sau(front/rear)")
    brake_front = models.CharField(max_length=150, blank=True, help_text="Hệ thống phanh trước")
    brake_rear = models.CharField(max_length=150, blank=True, help_text="Hệ thống phanh sau")
...
class ExteriorSpecification(SpecificationDisplayMixin, models.Model):
    ...
    # exterior
    headlamp = models.CharField(max_length=150, blank=True, help_text="Đèn chiếu sáng trước")
    low_beam_headlight = models.CharField(max_length=150, blank=True, help_text="Đèn chiếu gần trước")
    high_beam_headlight = models.CharField(max_length=150, blank=True, help_text="Đèn chiếu xa")
    ...
    hls = models.CharField(max_length=150, blank=True, help_text="Hệ thống cân bằng góc chiếu")
    ...
    pabs = models.CharField(max_length=150, blank=True, help_text="Hệ thống cân bằng góc chiếu ")    # (Projection angle balancing system) 
    nlm = models.BooleanField(default=False, help_text="Chế độ đèn chờ dẫn đường")                  # (Navigation light mode)
    
    rearlamp = models.CharField(max_length=150, blank=True, help_text="Đèn hậu")
    foglamp = models.CharField(max_length=150, blank=True, help_text="Đèn sương mù")
    
    position_light = models.CharField(max_length=150, blank=True, help_text="Đèn vị trí")
    brake_light = models.CharField(max_length=150, blank=True, help_text="Đèn phanh")
    reverse_light = models.CharField(max_length=150, blank=True, help_text="Đèn lùi")
    turn_signal_lamp = models.CharField(max_length=150, blank=True, help_text="Tích hợp đèn báo rẽ")
    
    third_brake_lamp = models.CharField(max_length=150, blank=True, help_text="Đèn phanh trên cao, đèn phanh thứ 3")
    
    foglamp_front = models.CharField(max_length=150, blank=True, help_text="Đèn sương mù trước")
    foglamp_rear = models.CharField(max_length=150, blank=True, help_text="Đèn sương mù sau")
    
    # Outer mirrors
    mirror = models.CharField(max_length=150, default="", blank=True, help_text="Gương chiếu hậu ngoài")
    ...
    self_adjust_reverse = models.BooleanField(default=False, help_text="Gương tự điều chỉnh khi lùi")
    mirror_memory = models.BooleanField(default=False, help_text="Nhớ vị trí gương")
    mirror_color = models.CharField(max_length=150, blank=True, help_text="Màu gương")
    
    # wiper
    wiper_front = models.CharField(max_length=150, blank=True, help_text="Gạt mưa trước")
    wiper_rear = models.CharField(max_length=150, blank=True, help_text="Gạt mưa sau")
    rear_glass_defrogger = models.BooleanField(default=False, help_text="Chức năng sấy kính sau")
    
    antenna = models.CharField(max_length=150, blank=True, help_text="Ăng ten")
    outside_handle = models.CharField(max_length=150, blank=True, help_text="Tay nắm cửa ngoài xe")
    ...
    mudguard = models.CharField(max_length=150, blank=True, help_text="Chắn bùn")
...
class InteriorSpecification(SpecificationDisplayMixin, models.Model):
    ...
    # Interior
    steering_type = models.CharField(max_length=150, blank=True, help_text="Loại tay lái")
    steering_material = models.CharField(max_length=100, blank=True, help_text="Chất liệu tay lái")
    steering_adjust = models.CharField(max_length=100, blank=True, help_text="Điều chỉnh tay lái")
...
class SeatSpecification(SpecificationDisplayMixin, models.Model):
    ...
    # Seat
    seat_material = models.CharField(max_length=100, blank=True, help_text="Chất liệu bọc ghế")
    seat_type = models.CharField(max_length=150, default="", blank=True, help_text="Loại ghế")
    
    front_seat_type = models.CharField(max_length=100, blank=True, help_text="Loại ghế trước")
    driver_seat = models.CharField(max_length=100, blank=True, help_text="Điều chỉnh ghế lái")
    front_passeger_seat = models.CharField(max_length=100, blank=True, help_text="Điều chỉnh ghế hành khách")
    seat_memory = models.CharField(max_length=100, blank=True, help_text="Bộ nhớ vị trí ghế")
    
    rear_seat = models.CharField(max_length=100, blank=True, help_text="Ghế sau")
    ...
    rear_seat_armset = models.CharField(max_length=100, blank=True, help_text="Tựa tay hàng ghế sau")
...
class ComfortSpecification(SpecificationDisplayMixin, models.Model):
    ...
    display = models.CharField(max_length=100, blank=True, help_text="Màn hình giải trí")
    display_info_windsheld = models.BooleanField(default=False, help_text="Hiển thị thông tin trên kính lái")
    
    number_of_speaker = models.CharField(max_length=100, blank=True, help_text="Số loa")
    smart_connect = models.CharField(max_length=100, blank=True, help_text="Kết nối không dây")
    ...
    power_window = models.CharField(max_length=100, blank=True, help_text="Cửa sổ điều chỉnh điện")
...
class SafetySpecification(SpecificationDisplayMixin, models.Model):
    ...
    parking_camera = models.CharField(max_length=100, blank=True, help_text="camera hỗ trợ đỗ xe")
    ...
    airbag = models.CharField(max_length=100, blank=True, help_text="Túi khí")
    font_airbag = models.CharField(max_length=100, blank=True, help_text="Túi khí phía trước")
    front_side_airbag = models.CharField(max_length=100, blank=True, help_text="Túi khí bên hông phía trước")
    curtain_airbag = models.CharField(max_length=100, blank=True, help_text="Túi khí rèm")
    driver_knee_airbag = models.CharField(max_length=100, blank=True, help_text="Túi khí đầu gối người lái")
    
    seat_belt = models.CharField(max_length=100, blank=True, help_text="Dây đai an toàn")
    child_safety_lock = models.CharField(max_length=100, blank=True, help_text="Khóa an toàn trẻ em")
